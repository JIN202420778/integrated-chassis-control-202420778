...
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.
    ...
    info.student_id   = '202420778';
    info.name         = 'JINWOOJEONG';
    ...
    info.ai_usage = 'Gemini used for discussion of controller concepts and gain tuning. ChatGPT used for MATLAB code development and plotting.';
